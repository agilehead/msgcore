...
export type GQLActivityCountsResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['ActivityCounts'] = GQLResolversParentTypes['ActivityCounts']> = ResolversObject<{
  newConversationCount?: Resolver<GQLResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GQLConversationResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['Conversation'] = GQLResolversParentTypes['Conversation']> = ResolversObject<{
  ...
  lastMessageAt?: Resolver<GQLResolversTypes['String'], ParentType, ContextType>;
  messages?: Resolver<Array<GQLResolversTypes['Message']>, ParentType, ContextType>;
  participants?: Resolver<Array<GQLResolversTypes['ConversationParticipant']>, ParentType, ContextType>;
  title?: Resolver<Maybe<GQLResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GQLConversationConnectionResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['ConversationConnection'] = GQLResolversParentTypes['ConversationConnection']> = ResolversObject<{
  nodes?: Resolver<Array<GQLResolversTypes['Conversation']>, ParentType, ContextType>;
  pageInfo?: Resolver<GQLResolversTypes['PageInfo'], ParentType, ContextType>;
  totalCount?: Resolver<GQLResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GQLConversationParticipantResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['ConversationParticipant'] = GQLResolversParentTypes['ConversationParticipant']> = ResolversObject<{
  displayName?: Resolver<Maybe<GQLResolversTypes['String']>, ParentType, ContextType>;
  lastSeenAt?: Resolver<Maybe<GQLResolversTypes['String']>, ParentType, ContextType>;
...
export type GQLMessageResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['Message'] = GQLResolversParentTypes['Message']> = ResolversObject<{
  ...
  conversationId?: Resolver<GQLResolversTypes['String'], ParentType, ContextType>;
  createdAt?: Resolver<GQLResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<GQLResolversTypes['String'], ParentType, ContextType>;
  ...
  replyTo?: Resolver<Maybe<GQLResolversTypes['String']>, ParentType, ContextType>;
...
export type GQLMutationResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['Mutation'] = GQLResolversParentTypes['Mutation']> = ResolversObject<{
  createConversation?: Resolver<GQLResolversTypes['Conversation'], ParentType, ContextType, RequireFields<GQLMutationCreateConversationArgs, 'input'>>;
  deleteMessage?: Resolver<GQLResolversTypes['Boolean'], ParentType, ContextType, RequireFields<GQLMutationDeleteMessageArgs, 'messageId'>>;
  markAllSeen?: Resolver<GQLResolversTypes['Boolean'], ParentType, ContextType>;
  markConversationSeen?: Resolver<GQLResolversTypes['Boolean'], ParentType, ContextType, RequireFields<GQLMutationMarkConversationSeenArgs, 'conversationId'>>;
  sendMessage?: Resolver<GQLResolversTypes['Message'], ParentType, ContextType, RequireFields<GQLMutationSendMessageArgs, 'body' | 'conversationId'>>;
}>;
...
export type GQLQueryResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['Query'] = GQLResolversParentTypes['Query']> = ResolversObject<{
  activityCounts?: Resolver<GQLResolversTypes['ActivityCounts'], ParentType, ContextType>;
  conversation?: Resolver<Maybe<GQLResolversTypes['Conversation']>, ParentType, ContextType, RequireFields<GQLQueryConversationArgs, 'id'>>;
  conversationByContext?: Resolver<Maybe<GQLResolversTypes['Conversation']>, ParentType, ContextType, RequireFields<GQLQueryConversationByContextArgs, 'contextId' | 'contextType' | 'participantId'>>;
  health?: Resolver<GQLResolversTypes['String'], ParentType, ContextType>;
  myConversations?: Resolver<GQLResolversTypes['ConversationConnection'], ParentType, ContextType, Partial<GQLQueryMyConversationsArgs>>;
}>;
